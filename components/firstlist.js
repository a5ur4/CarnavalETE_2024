...
const Firstlist = () => {
  const blocks = [
    { id: 1, color: '#F9CD0F', text: '190', image: 'https://cdn-icons-png.flaticon.com/512/26/26300.png', phoneNumber: '190' },
    { id: 2, color: '#F9CD0F', text: '192', image: 'https://cdn-icons-png.flaticon.com/512/1976/1976701.png', phoneNumber: '192' },
    { id: 3, color: '#F9CD0F', text: '193', image: 'https://cdn-icons-png.flaticon.com/512/7341/7341048.png', phoneNumber: '193' },
  ];
        ...
        {blocks.map((block) => (
          <View key={block.id} style={[styles.block, { backgroundColor: block.color }]}>
            <TouchableOpacity
              ...
              onPress={() => makePhoneCall(block.phoneNumber)}
            >
